/*
Pre-requisite 1: Need to execute the EDI_EODP_FI_SETUP.sql file before executing this.
...
Query to create a Stored Procedure for EODP_FI.
...
CREATE PROCEDURE EDI_EODP.OPERATIONS.EODP_FI_SP()
RETURNS STRING
LANGUAGE PYTHON
RUNTIME_VERSION = '3.8'
...
def eodp_fi_sp(session):

    # Variable Declaration.  
    tempTableName = 'EDI_EODP.OPERATIONS.EODP_FI_INC_TEMP'
    finalTableName = 'EDI_EODP.PROD.EODP_FI_INC'
    errorTableName = 'EDI_EODP.OPERATIONS.EODP_FI_INC_ERROR'
    ...
    try:
        ...
        return f"INSERTED NEW RECORDS FROM S3 to FI TABLE SUCCESSFULLY.";
