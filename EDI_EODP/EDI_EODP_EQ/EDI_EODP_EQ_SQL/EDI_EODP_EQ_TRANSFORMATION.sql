/*
Pre-requisite 1: Need to execute the EDI_EODP_EQ_SETUP.sql file before executing this.
...
Query to create a Stored Procedure for EODP_EQ.
...
CREATE PROCEDURE EDI_EODP.OPERATIONS.EODP_EQ_SP()
RETURNS STRING
LANGUAGE PYTHON
RUNTIME_VERSION = '3.8'
...
def eodp_eq_sp(session):

    # Variable Declaration.  
    tempTableName = 'EDI_EODP.OPERATIONS.EODP_EQ_INC_TEMP'
    finalTableName = 'EDI_EODP.PROD.EODP_EQ_INC'
    errorTableName = 'EDI_EODP.OPERATIONS.EODP_EQ_INC_ERROR'
    ...
    try:
        ...
        return f"INSERTED NEW RECORDS FROM S3 to EODP_EQ TABLE SUCCESSFULLY.";
