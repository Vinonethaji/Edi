...
*/
LIST @EDI_EODP.OPERATIONS.EODP_EQ_STAGE;
...
*/ 
SELECT SYSTEM$PIPE_STATUS('EDI_EODP.OPERATIONS.EODP_EQ_SNOWPIPE');
/*
...
*/ 
ALTER PIPE EDI_EODP.OPERATIONS.EODP_EQ_SNOWPIPE REFRESH; 
/*
...
*/  
SELECT *
FROM TABLE(EDI_EODP.INFORMATION_SCHEMA.COPY_HISTORY(TABLE_NAME=>'EDI_EODP.OPERATIONS.EODP_EQ_INC_LANDING', START_TIME=> DATEADD(HOURS, -24, CURRENT_TIMESTAMP())));
/*
View the content of the Landing Table.
*/ 
SELECT * FROM EDI_EODP.OPERATIONS.EODP_EQ_INC_LANDING;
/*
Queries related to Stream

Display all the data in a specified stream.
*/ 
SELECT * FROM EDI_EODP.OPERATIONS.EODP_EQ_STREAM;
/* 
Queries related to Temp Table

View the content of the Temp Table.
*/ 
SELECT * FROM EDI_EODP.OPERATIONS.EODP_EQ_INC_TEMP;
/* 
Queries Related to Final Table

View the content of the Prod Table.
*/ 
SELECT * FROM EDI_EODP.PROD.EODP_EQ_INC;
/*
Queries Related to Error Table

View the content of the Error Table.
*/
SELECT * FROM EDI_EODP.OPERATIONS.EODP_EQ_INC_ERROR;
/* 
...
*/ 
DESCRIBE TASK EDI_EODP.OPERATIONS.EODP_EQ_PUSH_STREAM_TO_TEMP;

DESCRIBE TASK EDI_EODP.OPERATIONS.EODP_EQ_PUSH_TO_EODP_EQ_INC;
/*
...
*/
CALL EDI_EODP.OPERATIONS.EODP_EQ_SP();


/*
Queries related to Secure View on EODP_EQ

Verify the view designed with specific conditions.
Executing a query to verify the secure view on EODP_EQ table.
*/ 

-- Selecting all columns from the secure view 
SELECT * FROM EDI_EODP.PROD.EODP_EQ_INC_PRODUCT 


/*
Queries related to Secure View on EODP_LOOKUP

verify the view designed with specific conditions.
Executing a query to verify the secure view on EODP_LOOKUP table.
*/ 

-- Selecting all columns from the secure view 
SELECT * FROM EDI_EODP.PROD.EODP_LOOKUP_PRODUCT  
