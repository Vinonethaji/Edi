...
*/
LIST @EDI_EODP.OPERATIONS.EODP_IX_STAGE;
...
*/ 
SELECT SYSTEM$PIPE_STATUS('EDI_EODP.OPERATIONS.EODP_IX_SNOWPIPE');
/*
...
*/ 
ALTER PIPE EDI_EODP.OPERATIONS.EODP_IX_SNOWPIPE REFRESH; 
/*
...
*/  
SELECT *
FROM TABLE(EDI_EODP.INFORMATION_SCHEMA.COPY_HISTORY(TABLE_NAME=>'EDI_EODP.OPERATIONS.EODP_IX_INC_LANDING', START_TIME=> DATEADD(HOURS, -24, CURRENT_TIMESTAMP())));
/*
View the content of the Landing Table.
*/ 
SELECT * FROM EDI_EODP.OPERATIONS.EODP_IX_INC_LANDING;
/*
Queries related to Stream

Display all the data in a specified stream.
*/ 
SELECT * FROM EDI_EODP.OPERATIONS.EODP_IX_STREAM;
/* 
Queries related to Temp Table

View the content of the Temp Table.
*/ 
SELECT * FROM EDI_EODP.OPERATIONS.EODP_IX_INC_TEMP;
/* 
Queries Related to Final Table

View the content of the Prod Table.
*/ 
SELECT * FROM EDI_EODP.PROD.EODP_IX_INC;
/*
Queries Related to Error Table

View the content of the Error Table.
*/
SELECT * FROM EDI_EODP.OPERATIONS.EODP_IX_INC_ERROR;
/* 
...
*/ 
DESCRIBE TASK EDI_EODP.OPERATIONS.EODP_IX_PUSH_STREAM_TO_TEMP;

DESCRIBE TASK EDI_EODP.OPERATIONS.EODP_IX_PUSH_TO_EODP_IX_INC;
/*
...
*/
CALL EDI_EODP.OPERATIONS.EODP_IX_SP();


/*
Queries related to Secure View on EODP_IX

Verify the view designed with specific conditions.
Executing a query to verify the secure view on EODP_IX table.
*/ 

-- Selecting all columns from the secure view 
SELECT * FROM EDI_EODP.PROD.EODP_IX_INC_PRODUCT 
